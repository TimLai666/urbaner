...
def build_report(
    ...
    lines: list[str] = []
    lines.append("# Choice Logit Report")
    lines.append("")
    ...
    lines.append("")
    lines.append("## Step 1. Choice Data")
    ...
    lines.append("")
    lines.append("## Step 2. Dummy Encoding")
    ...
    lines.append("")
    lines.append("### Attributes used")
    for spec in attribute_specs:
        label = spec["label_zh"] or spec["label"]
        lines.append(f"- {spec['attribute_key']}: {label}")
    lines.append("")
    lines.append("## Step 3. Logit Fit")
